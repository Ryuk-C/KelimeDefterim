...
class dilAdapter(private val dillerListesi: java.util.ArrayList<Diller>,
private val listener : dilAdapter.OnItemClickListener)
    ...
    override fun onBindViewHolder(holder: dilKartiTasarimTutucu, position: Int) {
      ...
      /*      val intent = Intent(holder.itemView.context, ListelerimFragment::class.java)
            intent.putExtra("dilNesne", dillerListesi[position].dil_id)
