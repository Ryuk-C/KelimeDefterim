...
interface KelimelerDaoInterface {
    ...
    /*
        ...
        @FormUrlEncoded
        fun kelimeAra(@Field("ingilizce") ingilizce: String): Call<CRUDCevap>
    */
    @POST("Haznedar/KelimeDefterim/girisYap.php")
    @FormUrlEncoded
    fun kullaniciAra(@Field("Pst_EMail") Pst_EMail: String, @Field("Pst_Sifre") Pst_Sifre: String): Call<CRUDCevap>

    @POST("Haznedar/KelimeDefterim/insert_kisiler.php")
    @FormUrlEncoded
    fun kullaniciEkle(@Field("Pst_EMail") Pst_EMail: String, @Field("Pst_Sifre") Pst_Sifre: String): Call<CRUDCevap>

    @POST("Haznedar/KelimeDefterim/insert_kelimeler.php")
    @FormUrlEncoded
    fun kelimeEkle(@Field("Pst_DilID") Pst_DilID: Int,
